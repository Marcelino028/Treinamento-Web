    ...
    vm = new Vue({
        ...
        methods: {
            filtrarForm() {
                ...
                vm.enviarFiltro(filtro_perfil, filtro_status, filtro_inicio, filtro_fim);
            },
            ...
            enviarFiltro(filtro_perfil, filtro_status, filtro_inicio, filtro_fim) {
                ...
                jQuery.ajax({
                    ...
                    data: { filtro_perfil: filtro_perfil, filtro_status: filtro_status, filtro_inicio: filtro_inicio, filtro_fim: filtro_fim },
