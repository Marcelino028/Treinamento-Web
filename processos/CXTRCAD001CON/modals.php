    ...
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"> Editar cadastro de Usuário</h4>
            ...
            <div class="modal-footer">
                <button id="cancela_editar" type="button" class="btn btn-danger" data-dismiss="modal">Cancelar
                    <i class="fa fa-remove" aria-hidden="true"></i></button>
                <button type="button" id="confirma_editar" class="btn btn-success">Confirmar <i
